      ...
      <div className="fixed inset-0 flex items-center justify-center z-[9999]">
        <div className="bg-white w-full max-w-3xl mx-auto rounded-lg shadow-lg p-4 max-h-[90vh] flex flex-col">
          ...
          <div className="overflow-y-auto px-4" style={{ flexGrow: 1 }}>
            ...
            {/* // Time of Occasion chip selection */}
            <FilterSection
              title="Time of Occasion"
            ...
            <div className="flex gap-2 flex-wrap">
              {timeOfOccasionOptions.map((opt) => (
                <Chip
                  key={opt}
                  label={opt}
                  selected={isSelected("timeOfOccasion", opt)}
                  onClick={() => toggleFilterValue("timeOfOccasion", opt)}
                />
              ))}
            </div>
