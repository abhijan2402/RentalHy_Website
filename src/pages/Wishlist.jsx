...
const Wishlist = () => {
  ...
  return (
    <div className="flex-1 mt-16 mx-[140px] bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen px-4 py-8">
      {/* Header Section */}
      <motion.div
      ...
      >
        <h1 className="text-3xl font-bold text-[#7C0902] flex justify-center items-center gap-2">
          <FaHeart /> My Wishlist
        </h1>
      ...
      {propertyData.length === 0 ? (
        ...
        >
          ...
          <h2 className="text-lg font-semibold">No Wishlist Items</h2>
          <p className="text-sm">Start adding properties to your wishlist!</p>
        </motion.div>
      ) : (
