...
const roomTypes = ["Single", "Double", "Triple", "4", "Dormitory"];
...
const occupancyCapacity = ["10-20", "20-50", "50+"];
              ...
              <div className="flex flex-wrap gap-2">
                ...
                {roomTypes.map((rt) => (
                  <Chip
                    key={rt}
                    label={rt}
                    selected={isSelected("roomTypes", rt?.toLowerCase())}
                    onClick={() =>
                      toggleFilterValue("roomTypes", rt?.toLowerCase())
                    }
                  />
                ))}{" "}
              </div>{" "}
              ...
              <div className="flex flex-wrap gap-2">
                ...
                {genders.map((g) => (
                  <Chip
                    key={g}
                    label={g}
                    selected={isSelected("genders", g?.toLowerCase())}
                    onClick={() =>
                      toggleFilterValue("genders", g?.toLowerCase())
                    }
                  />
                ))}{" "}
              </div>{" "}
              ...
              <div className="flex flex-wrap gap-2">
                ...
                {facilities.map((f) => (
                  <Chip
                    key={f}
                    label={f}
                    selected={isSelected("facilities", f?.toLowerCase())}
                    onClick={() =>
                      toggleFilterValue("facilities", f?.toLowerCase())
                    }
                  />
                ))}{" "}
              </div>{" "}
              ...
              <div className="flex flex-wrap gap-2">
                ...
                {foodOptions.map((food) => (
                  <Chip
                    key={food}
                    label={food}
                    selected={isSelected("foodOptions", food?.toLowerCase())}
                    onClick={() =>
                      toggleFilterValue("foodOptions", food?.toLowerCase())
                    }
                  />
                ))}{" "}
              </div>{" "}
              ...
              <div className="flex flex-wrap gap-2">
                ...
                {stayTypes.map((st) => (
                  <Chip
                    key={st}
                    label={st}
                    selected={isSelected("stayTypes", st?.toLowerCase())}
                    onClick={() =>
                      toggleFilterValue("stayTypes", st?.toLowerCase())
                    }
                  />
                ))}{" "}
              </div>{" "}
              ...
              <div className="flex flex-wrap gap-2">
                ...
                {occupancyCapacity.map((oc) => (
                  <Chip
                    ...
                    onClick={() =>
                      toggleFilterValue("occupancyCapacity", oc?.toLowerCase())
                    }
                  />
                ))}{" "}
              </div>{" "}
